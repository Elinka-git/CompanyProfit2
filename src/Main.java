...
public class Main {
	...
	public static void main(String[] args, String name, String dateOfEstablishment, String bulstat, String ownerName, Double initialCapital, Double currentCapital, Double profit) {
